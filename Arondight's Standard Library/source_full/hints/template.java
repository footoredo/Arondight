...
setScale(int scale(精度) , int round_mode) | stripTrailingZeros ()
// StringBuilder
StringBuilder sb = new StringBuilder ();
sb.append(elem) | out.println(sb)
// Collection
.add(Object o) => boolean | .clear() | .isEmpty() | .contains() | .size() | .toArray() | .remove()
for (Object o: s) {}
// Set
Set s = new HashSet () | TreeSet ();
// List
List s = new LinkedList () | ArrayList ();
.add([int index,] E e) | .get (int index) | .indexOf (Object o) | .set (int index, E e) | .subList (int l, int r) | .remove (int index)
